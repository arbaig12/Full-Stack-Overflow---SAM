/**
 * @file degreeRequirementRoutes.js
 * @description This file defines the Express router for handling degree requirement imports.
 * It exposes an API endpoint for uploading a YAML file containing degree requirement data.
 ...
 * @requires ./degreeRequirementModel.js - The model functions for the Degree Requirement concept.
 */
...
/**
 * @route POST /api/import/degree-requirements
 * @description Handles the upload and import of a degree requirement YAML file.
 *
 ...
 * 3. Calls the `importDegreeRequirement` model function to persist the data.
 ...
 *
 * @returns {object} 200 - Success response with a confirmation message and the new requirement's ID.
 * @returns {object} 400 - Error response if no file is uploaded or the YAML is invalid.
 * @returns {object} 409 - Conflict response if degree requirements for the specified program already exist.
