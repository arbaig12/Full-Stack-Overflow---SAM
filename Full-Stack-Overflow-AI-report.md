...
Our team used AI coding assistants extensively throughout the development of SAM (SBU Academics Management). We primarily used **ChatGPT integrated in Visual Studio Code** and **Cursor** (an AI-powered code editor) as our main AI coding assistants during development. We used AI tools for frontend, backend, database work, testing, and connecting frontend with backend APIs. AI assistance was particularly valuable for generating and debugging code across the front-end, back-end, and database layers, as well as for generating YAML degree requirement data files and comprehensive test suites.
...
When designing UI components, ChatGPT often provided detailed JSX structure and inline CSS. However, its output sometimes included redundant logic and components, which we needed to simplify for clarity.
...
For HW9, we used Cursor to generate comprehensive frontend test files using React Testing Library. The AI helped create test cases for all 12 page components, including:

- Component rendering tests
- User interaction tests (clicking, typing, selecting)
- Filtering and sorting functionality tests
- State management tests

**Example prompt:**
"Create a test file for CourseCatalog component that tests rendering, filtering by department, and sorting functionality."

The AI generated well-structured test files with proper setup, mocking, and assertions that followed React Testing Library best practices.
...
```javascript
// AI-generated date wrapper for configurable current date
...
**AI assistance:**
The AI generated well-structured test files with:
- Proper Express app setup for testing
...
### c. HW9 Database Schema Updates

For HW9, we used AI to help understand and work with existing database schemas when updating routes. AI assisted in:
- Understanding foreign key relationships
- Writing complex JOIN queries for course catalog with prerequisites
- Optimizing queries for performance
- Understanding enum types and how to handle them in queries
...
- Analyze which routes needed more comprehensive testing

**Example:**
When we saw that `importRoutes.js` had only 48% coverage, we used AI to generate additional test cases for edge cases and error scenarios.
...
### b. Route Compliance Review

For HW9, we used AI to:
- Review routes against project requirements
- Identify missing fields in API responses
- Suggest improvements for error handling
- Ensure RESTful API design compliance
...
We used AI to help create:
- Route compliance documentation
- Test report with coverage statistics
...
AI coding assistants (ChatGPT and Cursor) were invaluable tools throughout the SAM project development, especially for HW9. They helped us:

1. Generate clean, functional code quickly
2. Debug complex issues efficiently
3. Create comprehensive test suites
4. Ensure route compliance with requirements
...
**Project**: SBU Academics Management (SAM)  
**Team**: Full Stack Overflow
